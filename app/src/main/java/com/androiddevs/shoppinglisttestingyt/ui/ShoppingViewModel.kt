...
class ShoppingViewModel @ViewModelInject constructor(
    ...
    fun insertShoppingItem(name: String, amountString: String, priceString: String) {
        ...
        insertShoppingItemIntoDb(shoppingItem)  // actual insertion after validation
        setCurImageUrl("")  // reset the image url after the insertion
